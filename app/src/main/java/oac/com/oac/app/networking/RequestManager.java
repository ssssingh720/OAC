package oac.com.oac.app.networking;
...
public class RequestManager<T> {
    ...
    public static final String TESTING_SERVER = "http://www.oacasia.org/api/";
    public static final String LIVE_SERVER = "http://www.oacasia.org/api/";
