...
//        imgAboutUs = (ImageView) mView.findViewById(R.id.imgAboutUs);
        ...
        ImageView imgAbtOAC_logo = (ImageView) mView.findViewById(R.id.imgAbtOAC_logo);
        ImageView imgAbtOAA_logo = (ImageView) mView.findViewById(R.id.imgAbtOAA_logo);
        ...
        Picasso.with(getActivity()).load(RequestManager.LIVE_SERVER+SharedPrefManager.getInstance().getSharedDataString(FeedParams.OAA_LOGO))
                .placeholder(R.drawable.app_logo).error(R.drawable.app_logo).into(imgAbtOAA_logo);
        Picasso.with(getActivity()).load(RequestManager.LIVE_SERVER+SharedPrefManager.getInstance().getSharedDataString(FeedParams.OAC_LOGO))
                .placeholder(R.drawable.app_logo).error(R.drawable.app_logo).into(imgAbtOAC_logo);
        ...
        if (Util.isNetworkOnline(getActivity())) {
            ...
            params.put(FeedParams.CODE, "about-us");
