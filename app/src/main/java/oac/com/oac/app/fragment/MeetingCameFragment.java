 ...
 */
public class MeetingCameFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (Util.isNetworkOnline(context)) {
            ...
            placeRequest(APIMethods.MEETING_REQUEST_CAME, MeetingRequestDetailVo.class, params, true, null);
        } else {
    ...
    public void onAPIResponse(Object response, String apiMethod) {
        ...
        if (apiMethod.equalsIgnoreCase(APIMethods.MEETING_REQUEST_CAME)) {
            loadToast.success();
