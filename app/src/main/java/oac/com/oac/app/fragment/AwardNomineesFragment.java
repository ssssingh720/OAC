...
import oac.com.oac.app.adapter.AwardNomineeAdapter;
...
import oac.com.oac.app.modal.AwardNomineeVO;
 ...
 */
public class AwardNomineesFragment  extends BaseFragment{
...
//        imgTopRightLogo.setImageResource(R.drawable.jury_logo);
        txtTitle.setText(getResources().getString(R.string.award_nominees));
        ...
        if (Util.isNetworkOnline(getActivity())) {
            ...
            placeRequest(APIMethods.NOMINEE_LIST, AwardNomineeVO.class, params, true, null);
        } else {
    ...
    public void onAPIResponse(Object response, String apiMethod) {
        ...
        if (apiMethod.equalsIgnoreCase(APIMethods.NOMINEE_LIST)) {
            loadToast.success();
            AwardNomineeVO speakersVo = (AwardNomineeVO) response;
            RecyclerView.Adapter chapterVideoAdapter = new AwardNomineeAdapter(getActivity(), speakersVo.getSpeakersList());
