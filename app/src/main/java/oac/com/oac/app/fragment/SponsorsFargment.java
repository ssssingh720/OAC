...
import oac.com.oac.app.adapter.SponsorsAdapter;
 ...
 */
public class SponsorsFargment extends BaseFragment {
...
//        txtAboutUs = (TextView) mView.findViewById(R.id.txtAboutUs);
        ...
        if (Util.isNetworkOnline(getActivity())) {
            ...
            params.put(FeedParams.CODE, "partners");
...
//    @Override
//    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
//        mView = inflater.inflate(R.layout.sponsers_frag, container, false);
//
//        grdSponsors = (GridView) mView.findViewById(R.id.grdSponsors);
//        TextView txtTitle=(TextView)mView.findViewById(R.id.txtTitle);
//
//        txtTitle.setText("Partner");
//
//        Display display = getActivity().getWindowManager().getDefaultDisplay();
//        Point size = new Point();
//        display.getSize(size);
...
//        super.onAPIResponse(response, apiMethod);
//
//        if (apiMethod.equalsIgnoreCase(APIMethods.SPONSOR_LIST)) {
//            loadToast.success();
//            SponsorsVo sponsorsVo = (SponsorsVo) response;
//            SponsorsAdapter chapterVideoAdapter = new SponsorsAdapter(getActivity(), sponsorsVo.getSponsorsList());
